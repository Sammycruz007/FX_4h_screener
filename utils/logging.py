...
utils/logging.py
----------------
Production-grade logging for the FX Scanner pipeline.
...
#   - get_volume_logger — no Volume Classifier for FX (no real volume
#     data exists for a decentralized OTC market, see fetcher.py's
#     docstring)
#   - get_relative_strength_logger — replaced by get_csi_logger; CSI
#     (engines/csi.py) is the FX relative-strength engine, not a
#     sector-ETF-based one
#   - get_sentiment_logger — no sentiment engine exists anywhere in
#     this project
#   - get_airflow_logger — this project's orchestrator is
#     run_pipeline_cloud.py via GitHub Actions, not Airflow; replaced
#     by get_pipeline_logger
#
# WHAT'S ADDED:
#   - get_csi_logger — engines/csi.py (Currency Strength Index)
...
def get_csi_logger()       -> logging.Logger:
    return get_logger("csi_engine",    "engines.log")
